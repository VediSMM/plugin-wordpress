...
final class MetaBox
{
    ...
    public function render(): void
    {
        ...
        echo '<input type="checkbox" id="vedismm-shorten-links" name="vedismm_tracking[shorten_links]" value="1" aria-describedby="vedismm-shorten-links-help"> ';
        ...
        echo '<input type="checkbox" id="vedismm-add-source" name="vedismm_tracking[add_source]" value="1" aria-describedby="vedismm-add-source-help" aria-disabled="true" disabled> ';
